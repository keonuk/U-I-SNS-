...
<body>
			...
			<ul class="sidebar-menu" id="nav-accordion">
				<p class="centered">
					<a href="./MyPageView.sr"> <img
						src="./upload/<%=session.getAttribute("PhotoName") %>" class="img-circle"
						width="120px" height="120px" alt="이미지 없음"></a>
				</p>
	...
	<div class="row mt wrapper main-content">
				<h1>방명록</h1>
				<form method = "post" action = "./VisitModifyAction.sr">
				...
				<table>
					...
					<tr>			
						 ...
						 <input type="button" value = "삭제" onclick = "location.href='./VisitDelete.sr?num=<%=visit.getV_NUM()%>'">&nbsp;&nbsp;
						 <input type="button" value = "리스트" onclick = "location.href='./VisitListAction.sr'">	&nbsp;&nbsp;</td>
