...
public class VisitAddAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("sex10==>" + sex);
		System.out.println("getId10==> " + id);
		visitdata.setV_PHOTO(sex);
		visitdata.setV_ID(id);
		...
		//이동할 경로를 지정합니다.
		forward.setPath("./VisitListAction.sr");
		return forward;
	} catch (Exception ex) {
		ex.printStackTrace();
	}
